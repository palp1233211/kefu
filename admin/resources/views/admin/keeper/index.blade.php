                ...
                <form class="layui-form layui-form-pane" action="/brandsShow" data-type="" data-table="currentTableId"  >
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="identity" lay-verify="lever" >
...
{{--                <button class="layui-btn layui-btn-sm layui-btn-danger data-delete-btn" lay-event="delete"> 删除 </button>--}}
        ...
        <script type="text/html" id="currentTableBar">
            ...
            <a class="layui-btn  layui-btn-xs data-count-add" lay-event="addUser">升为管理员</a>
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {
                    field: 'identity', width: 250, align: 'center', templet: function (d) {
                        if (d.identity == 0) {
                            return '<span class="layui-badge layui-bg-orange">会员</span>';
                        }
                        if (d.identity == 1) {
                ...
                {
                    field: 'avatarUrl', width: 100, align: 'center', templet: function (d) {
                        if (d.avatarUrl){
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                $.post('/keeper/editIdentity/'+ data.id, {id: data.id,'_method':'PUT','_token': '{{ csrf_token() }}' }, function (e) {
                    if (e.code == 2000) {
                        layer.msg(e.data)
                        // obj.del();
                        setTimeout(function () {
                ...
                {{--layer.confirm('真的删除行么？', function (index) {--}}
                {{--    $.post('/keeper/delete/'+ data.id, {id: data.id,'_method':'DELETE','_token': '{{ csrf_token() }}' }, function (e) {--}}
                {{--        if (e.code == 2000) {--}}
                {{--            layer.msg(e.data)--}}
                {{--            obj.del();--}}
                {{--        } else {--}}
