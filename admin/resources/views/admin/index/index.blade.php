    ...
    <div class="layui-header header">
        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item " onclick="dump()">
                    <a href="javascript:;" ><i class="fa fa-floppy-o"></i></a>
                </li>
                <li class="layui-nav-item" onclick="mysqlReductionDump()">
                    <a href="javascript:;" ><i class="fa fa-file-archive-o"></i></a>
                </li>
...
<script src="/static/jq/jquery.js" charset="utf-8"></script>
